<div class="sidebar">
    <nav class="sidebar-nav">
        ...
        <ul class="nav">
            ...
            @endcan
            <li class="nav-item">
                <a href="{{ route("admin.member-type.index") }}" class="nav-link {{ request()->is('admin/member-type') || request()->is('admin/member-type/*') ? 'active' : '' }}">
                    <i class="fa-fw fas fa-chart-line nav-icon">
            ...
            <li class="nav-item">
                <a href="{{ route("admin.bill.index") }}" class="nav-link {{ request()->is('admin/bill') || request()->is('admin/bill/*') ? 'active' : '' }}">
                    <i class="fa-fw fas fa-chart-line nav-icon">
